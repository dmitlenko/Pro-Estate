...
{
	[Table(Name = "Lessee")]
	public class Lessor : IIdentifable, IHumanData
	{
		...
		[Association(Name = "FK_Lessee_PassportData", IsForeignKey = true, ThisKey = "PassportDataId", OtherKey = "Id", Storage = "_passportData")]
