...
{
	[Table(Name = "Sell")]
	public class Sell : IIdentifable
	{
		...
		[Association(Name = "FK_Sell_Client", IsForeignKey = true, ThisKey = "ClientId", OtherKey = "Id", Storage = "_client")]
		...
		[Association(Name = "FK_Sell_Apartment", IsForeignKey = true, ThisKey = "ApartmentId", OtherKey = "Id", Storage = "_apartment")]
		public Apartment Apartment { get => _apartment.Entity; set => _apartment.Entity = value; }

		[Association(Name = "FK_Sell_Employee", IsForeignKey = true, ThisKey = "EmployeeId", OtherKey = "Id", Storage = "_employee")]
